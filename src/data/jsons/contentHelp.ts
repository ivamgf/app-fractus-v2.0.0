const contentHelp = {
    ...
    help: {
        ...
        title8: 'Como faço para baixar os textos?',
        text8: 'Vá até a página de textos, escolha o texto de sua preferência e clique em baixar. Será realizado então o download do arquivo.',
        title9: 'Posso usar o Fractus no meu IPhone?',
        text9: 'Sim, mas somente através do navegador. O aplicativo ainda não está disponível na loja da Apple.',
    },
    children: {
        routes: {
            route1: 'Início',
